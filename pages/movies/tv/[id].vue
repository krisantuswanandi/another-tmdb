...
const route = useRoute("movies-tv-id")
...
<template>
  <div v-if="tv" class="flex flex-col items-center">
    ...
    <div class="flex mt-4">
      ...
      <NuxtLink target="_blank" :to="`https://google.com/search?q=${encodeURIComponent(tv.name)}`">
